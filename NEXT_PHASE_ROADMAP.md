...
- Done: voice configuration foundation exists with Hermes-aligned `tts`/`stt` sections, `estacoda voice status/setup`, and OpenAI-compatible `voice.speak` audio artifact generation; transcription execution remains next.
