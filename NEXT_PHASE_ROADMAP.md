...
- Done: voice configuration foundation exists with Hermes-aligned `tts`/`stt` sections and `estacoda voice status/setup`; synthesis/transcription execution remains next.
