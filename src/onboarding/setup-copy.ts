...
export const SETUP_COPY_ENTRIES = [
  ...
  copy("setupEditor.actions.editLanguage", "Edit language", "عدّل اللغة", [], "interface-preference"),
  ...
  copy("setupEditor.actions.editWorkflowLearning.description", "Control how reusable workflows are learned from sessions.", "تحكّم في طريقة تعلّم سير العمل القابل لإعادة الاستخدام من الجلسات.", [], "workflow-learning"),
  copy("setupEditor.actions.editLanguage.description", "Choose English or Arabic. Arabic support is beta and may fall back to English.", "اختار الإنجليزية أو العربية. دعم العربية ما زال تجريبي وقد يرجع للإنجليزية أحيانًا.", [], "interface-preference"),
