...
export const SETUP_COPY_ENTRIES = [
  ...
  copy("setupEditor.actions.editFallbackModelRoute", "Edit fallback provider/model route.", "عدّل مسار المزوّد/النموذج الاحتياطي.", [], "provider-selection"),
  copy("setupEditor.actions.editAuxiliaryModelRoute", "Edit auxiliary provider/model route.", "عدّل مسار المزوّد/النموذج المساعد.", [], "provider-selection"),
  ...
  copy("setupEditor.actions.editFallbackModelRoute.description", "Choose or add a fallback provider/model route through a reviewed setup change.", "اختر أو أضف مسار مزوّد/نموذج احتياطي عبر تغيير إعداد تتم مراجعته.", [], "provider-selection"),
  copy("setupEditor.actions.editAuxiliaryModelRoute.description", "Choose an auxiliary route for assessor, compression, session search, memory compaction, or profile context.", "اختر مسارًا مساعدًا لـ assessor أو compression أو session_search أو memory_compaction أو profile_context.", [], "provider-selection"),
  copy("setupEditor.actions.configureChannels.description", "Configure remote-control channels through a reviewed setup change.", "اضبط قنوات التحكم عن بُعد عبر تغيير إعداد تتم مراجعته.", [], "optional-capability"),
  copy("setupEditor.actions.configureVoice.description", "Configure text-to-speech and speech-to-text settings.", "اضبط إعدادات تحويل النص إلى كلام وتحويل الكلام إلى نص.", [], "optional-capability"),
  copy("setupEditor.actions.configureImageGeneration.description", "Configure image generation provider settings.", "اضبط إعدادات مزوّد توليد الصور.", [], "optional-capability"),
  copy("setupEditor.actions.configureBrowser.description", "Configure browser backend settings without launching a browser now.", "اضبط إعدادات واجهة المتصفح دون تشغيل متصفح الآن.", [], "optional-capability"),
  ...
  copy("setupEditor.prompt.fallbackRoute.title", "Fallback provider/model route", "مسار المزوّد/النموذج الاحتياطي", [], "provider-selection"),
  copy("setupEditor.prompt.fallbackRoute.body", "Choose an existing fallback route to replace, or add another fallback route.", "اختر مسارًا احتياطيًا موجودًا لاستبداله، أو أضف مسارًا احتياطيًا آخر.", [], "provider-selection"),
  ...
  copy("setupEditor.prompt.fallbackRoute.edit.description", "Replace this fallback provider/model route after review.", "استبدل مسار المزوّد/النموذج الاحتياطي هذا بعد المراجعة.", [], "provider-selection"),
  copy("setupEditor.prompt.fallbackRoute.add", "Add another fallback route", "أضف مسارًا احتياطيًا آخر", [], "provider-selection"),
  copy("setupEditor.prompt.fallbackRoute.add.description", "Append a new fallback provider/model route after the existing fallbacks.", "أضف مسار مزوّد/نموذج احتياطيًا جديدًا بعد المسارات الحالية.", [], "provider-selection"),
  copy("setupEditor.prompt.auxiliaryRoute.title", "Choose auxiliary route.", "اختر مسارًا مساعدًا.", [], "provider-selection"),
  copy("setupEditor.prompt.auxiliaryRoute.body", "Choose the auxiliary task to route through a reviewed setup change.", "اختر مهمة المساعدة التي سيتم توجيهها عبر تغيير إعداد تتم مراجعته.", [], "provider-selection"),
  ...
  copy("setupEditor.prompt.auxiliaryRoute.compression.description", "Configure compression summarization route.", "اضبط مسار تلخيص compression.", [], "provider-selection"),
  copy("setupEditor.prompt.auxiliaryRoute.sessionSearch", "Session search", "بحث الجلسات", [], "provider-selection"),
  copy("setupEditor.prompt.auxiliaryRoute.sessionSearch.description", "Configure session_search route.", "اضبط مسار session_search.", [], "provider-selection"),
  copy("setupEditor.prompt.auxiliaryRoute.memoryCompaction", "Memory compaction", "ضغط الذاكرة", [], "provider-selection"),
  copy("setupEditor.prompt.auxiliaryRoute.memoryCompaction.description", "Configure memory_compaction route.", "اضبط مسار memory_compaction.", [], "provider-selection"),
  copy("setupEditor.prompt.auxiliaryRoute.profileContext", "Profile context", "سياق الملف الشخصي", [], "provider-selection"),
  copy("setupEditor.prompt.auxiliaryRoute.profileContext.description", "Configure profile_context route.", "اضبط مسار profile_context.", [], "provider-selection"),
  ...
  copy("setupDrafts.fallbackModelRoute.add.summary", "Add fallback route {providerId} / {modelId}.", "أضف مسارًا احتياطيًا {providerId} / {modelId}.", ["{providerId}", "{modelId}"], "provider-selection"),
  copy("setupDrafts.fallbackModelRoute.replace.summary", "Replace fallback route {previousProviderId} / {previousModelId} with {providerId} / {modelId}.", "استبدل المسار الاحتياطي {previousProviderId} / {previousModelId} بـ {providerId} / {modelId}.", ["{previousProviderId}", "{previousModelId}", "{providerId}", "{modelId}"], "provider-selection"),
  copy("setupDrafts.auxiliaryModelRoute.summary", "Set auxiliary {auxiliaryTask} route to {providerId} / {modelId}.", "اضبط مسار {auxiliaryTask} المساعد إلى {providerId} / {modelId}.", ["{auxiliaryTask}", "{providerId}", "{modelId}"], "provider-selection"),
