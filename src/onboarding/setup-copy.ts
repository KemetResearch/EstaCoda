...
export const SETUP_COPY_ENTRIES = [
  ...
  copy("setupEditor.shell.labels.userConfig", "User config", "إعداد المستخدم", [], "config-summary"),
  copy("setupEditor.shell.labels.projectConfig", "Project config", "إعداد المشروع", [], "config-summary"),
