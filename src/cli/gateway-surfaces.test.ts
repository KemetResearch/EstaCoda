...
function fakeGatewayStatusData(): GatewayStatusData {
  return {
    ...
    serviceManagerStates: [
      { kind: "none", installed: false, scope: "user", activeState: "unknown", profileId: "default" },
    ],
    identityLocks: [],
  };
}
...
function fakeGatewayDiagnoseData(): GatewayDiagnoseData {
  return {
    ...
    whatsapp: {
      ...
      bridgePackagePresent: true,
      bridgeLockfilePresent: true,
      bridgeEntrypointPresent: true,
      bridgeReadmePresent: true,
