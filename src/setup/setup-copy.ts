...
export const SETUP_COPY_ENTRIES = [
  ...
  copy("onboarding.workflowLearning.options.autonomous.description", "Record shadow-only autonomous decisions for review. No automatic promotion is active in Phase 1A.", "سجّل قرارات ذاتية في وضع shadow-only للمراجعة. لا توجد ترقية تلقائية مفعّلة في Phase 1A.", [], "workflow-learning"),
  ...
  copy("setupEditor.actions.configureWebSearch", "Configure Search", "اضبط بحث الويب", [], "optional-capability"),
  ...
  copy("setupEditor.actions.editWorkflowLearning.description", "Agent Evolution controls reviewable self-improvement proposals backed by evidence, evals, and manual promotion.", "يتحكم Agent Evolution في proposal تحسين ذاتي قابلة للمراجعة ومدعومة بالأدلة، والتقييمات، والترقية اليدوية.", [], "workflow-learning"),
  ...
  copy("setupEditor.actions.configureWebSearch.description", "Set the web.search provider without running a search.", "اضبط مزوّد web.search من غير تشغيل بحث.", [], "optional-capability"),
  ...
  copy("setupEditor.prompt.webSearch.provider.brave.description", "Use the Brave Search API with a reviewed credential reference.", "استخدم Brave Search API مع مرجع بيانات اعتماد تتم مراجعته.", ["API"], "optional-capability"),
  copy("setupEditor.prompt.webSearch.provider.ddgs", "DuckDuckGo / DDGS", "DuckDuckGo / DDGS", [], "optional-capability"),
  copy("setupEditor.prompt.webSearch.provider.ddgs.description", "Use the managed ddgs Python capability. Setup may install only the registered DDGS capability after review.", "استخدم قدرة Python المُدارة ddgs. قد يثبّت الإعداد قدرة DDGS المسجلة فقط بعد المراجعة.", [], "optional-capability"),
  ...
  copy("setupEditor.prompt.webSearch.brave.secretValue", "Enter {envVar} for {serviceName}, or leave blank to reuse an existing environment/profile secret.", "أدخل {envVar} لـ {serviceName}، أو اتركه فارغًا لإعادة استخدام سر موجود في البيئة أو الملف الشخصي.", ["{envVar}", "{serviceName}"], "credential-reference"),
