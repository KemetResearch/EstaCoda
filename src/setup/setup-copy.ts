...
export const SETUP_COPY_ENTRIES = [
  ...
  copy("onboarding.workflowLearning", "Agent Evolution controls whether EstaCoda may learn reusable Skills from your workflow patterns.", "يتحكم تطوّر الوكيل فيما إذا كان بإمكان EstaCoda تعلّم مهارات قابلة لإعادة الاستخدام من أنماط سير عملك.", [], "workflow-learning"),
  ...
  copy("setupEditor.actions.editWorkflowLearning", "Edit Agent Evolution", "عدّل تطوّر الوكيل", [], "workflow-learning"),
  ...
  copy("setupEditor.actions.editWorkflowLearning.description", "Agent Evolution controls whether EstaCoda may learn reusable Skills from your workflow patterns.", "يتحكم تطوّر الوكيل فيما إذا كان بإمكان EstaCoda تعلّم مهارات قابلة لإعادة الاستخدام من أنماط سير عملك.", [], "workflow-learning"),
  ...
  copy("setupEditor.prompt.channels.telegram.description", "Use the existing Telegram setup flow.", "استخدم مسار إعداد Telegram الحالي.", [], "optional-capability"),
