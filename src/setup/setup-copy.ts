...
export const SETUP_COPY_ENTRIES = [
  ...
  copy("setupEditor.prompt.browser.summary", "Choose a browser backend. Setup records references only; it will not launch a browser during planning.", "اختر محرك المتصفح. يسجّل الإعداد المراجع فقط؛ ولن يشغّل متصفحًا أثناء التخطيط.", [], "optional-capability"),
  copy("setupEditor.prompt.browser.backend", "Browser backend", "محرك المتصفح", [], "optional-capability"),
