...
export const SETUP_COPY_ENTRIES = [
  ...
  copy("onboarding.interfaceLanguage", "Choose the language EstaCoda uses for setup and CLI guidance.\nاختر اللغة التي يستخدمها EstaCoda في الإعداد وإرشادات الطرفية.", "Choose the language EstaCoda uses for setup and CLI guidance.\nاختر اللغة التي يستخدمها EstaCoda في الإعداد وإرشادات الطرفية.", [], "interface-preference"),
