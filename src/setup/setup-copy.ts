...
export const SETUP_COPY_ENTRIES = [
  ...
  copy("onboarding.providers.description.kimi", "Hosted Kimi models.", "نماذج Kimi المستضافة.", [], "provider-selection"),
  copy("onboarding.providers.description.openrouter", "Model access through OpenRouter.", "وصول إلى النماذج عبر OpenRouter.", [], "provider-selection"),
  copy("onboarding.providers.description.zai", "Hosted Z.ai models.", "نماذج Z.ai المستضافة.", [], "provider-selection"),
  copy("onboarding.providers.description.local", "Local OpenAI-compatible models.", "نماذج محلية متوافقة مع OpenAI.", [], "provider-selection"),
  ...
  copy("setupEditor.actions.configureWebSearch", "Configure search", "اضبط البحث", [], "optional-capability"),
  ...
  copy("setupEditor.prompt.webSearch.provider.ddgs.description", "Use DuckDuckGo (free). Setup requires installing the registered DDGS capability via Python review.", "استخدم DuckDuckGo مجانًا. يتطلب الإعداد تثبيت قدرة DDGS المسجلة عبر مراجعة Python.", [], "optional-capability"),
