...
export const SETUP_COPY_ENTRIES = [
  ...
  copy("setupEditor.prompt.vision.summary", "Configure image generation for image.generate. This is separate from the primary chat model.", "اضبط توليد الصور لأداة image.generate. هذا منفصل عن نموذج المحادثة الأساسي.", ["image.generate"], "optional-capability"),
  ...
  copy("setupEditor.prompt.vision.provider.fal.description", "Hosted fal.ai image models. Good default if you already use FAL_KEY.", "نماذج صور مستضافة عبر fal.ai. خيار جيد إذا كنت تستخدم FAL_KEY بالفعل.", ["fal.ai", "FAL_KEY"], "optional-capability"),
  ...
  copy("setupEditor.prompt.vision.model.body", "Choose the image model for image.generate.", "اختر نموذج الصور الذي ستستخدمه image.generate.", ["image.generate"], "optional-capability"),
