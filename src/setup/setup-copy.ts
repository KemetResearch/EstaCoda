...
export const SETUP_COPY_ENTRIES = [
  ...
  copy("setupEditor.prompt.vision.summary", "Configure image generation for image.generate and supported image.edit models. This is separate from the primary chat model.", "اضبط توليد الصور لأداة image.generate ونماذج image.edit المدعومة. هذا منفصل عن نموذج المحادثة الأساسي.", ["image.generate", "image.edit"], "optional-capability"),
  copy("setupEditor.prompt.vision.provider", "Image-generation provider", "مزوّد توليد الصور", [], "optional-capability"),
  copy("setupEditor.prompt.vision.provider.fal", "FAL", "FAL", ["FAL"], "optional-capability"),
  copy("setupEditor.prompt.vision.provider.fal.description", "Hosted fal.ai image generation and editing models. Good default if you already use FAL_KEY.", "نماذج توليد وتعديل صور مستضافة عبر fal.ai. خيار جيد إذا كنت تستخدم FAL_KEY بالفعل.", ["fal.ai", "FAL_KEY"], "optional-capability"),
  copy("setupEditor.prompt.vision.provider.byteplus", "BytePlus ModelArk / Seedream", "BytePlus ModelArk / Seedream", ["BytePlus", "ModelArk", "Seedream"], "optional-capability"),
  copy("setupEditor.prompt.vision.provider.byteplus.description", "BytePlus Seedream image generation. Requires an Ark API key and model access enabled in ModelArk.", "توليد صور عبر BytePlus Seedream. يتطلب مفتاح Ark API وتفعيل الوصول إلى النموذج في ModelArk.", ["BytePlus", "Seedream", "Ark API", "ModelArk"], "optional-capability"),
  copy("setupEditor.prompt.vision.model.title", "Image model", "نموذج الصور", [], "optional-capability"),
  copy("setupEditor.prompt.vision.model.body", "Choose the image model for image.generate and supported image.edit requests.", "اختر نموذج الصور الذي سيستخدمه image.generate وطلبات image.edit المدعومة.", ["image.generate", "image.edit"], "optional-capability"),
