...
export const SETUP_COPY_ENTRIES = [
  ...
  copy("setupEditor.prompt.openaiCompatible.intro.process", "EstaCoda will confirm the endpoint, discover models from /models when available, let you choose or enter a model ID, configure optional authentication, then offer a chat completion test before review.", "ستؤكد EstaCoda نقطة النهاية، وتحاول اكتشاف النماذج من /models عند توفرها، ثم تتيح لك اختيار نموذج أو إدخال معرّفه يدويًا، وضبط المصادقة الاختيارية، وبعدها تعرض اختبار إكمال المحادثة قبل المراجعة.", ["EstaCoda", "/models"], "provider-selection"),
  ...
  copy("setupEditor.prompt.openaiCompatible.intro.continue.description", "Use the shown endpoint and continue.", "استخدم نقطة النهاية المعروضة وتابع.", [], "provider-selection"),
  ...
  copy("setupEditor.prompt.openaiCompatible.endpoint.baseUrl", "Endpoint URL [{baseUrl}] - press ENTER to use this default:", "عنوان URL لنقطة النهاية [{baseUrl}] - اضغط ENTER لاستخدام هذا الافتراضي:", ["{baseUrl}", "URL", "ENTER"], "provider-selection"),
