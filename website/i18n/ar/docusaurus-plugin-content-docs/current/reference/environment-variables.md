...
لا يستخدم WhatsApp متغير بيئة لرمز بوت. مصادقة الجهاز تتم عبر QR فقط من خلال `estacoda whatsapp`، وتبقى اعتمادات الجسر معزولة داخل `scripts/whatsapp-bridge/`.
