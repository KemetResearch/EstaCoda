...
| Skill learning and autonomous local skill creation | `skills.autonomy` modes above `suggest` | Creates skills automatically from bounded workflow observations. |
