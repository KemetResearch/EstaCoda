...
- ACP foundation now exists, but it is still a first slice: no full editor approval handshake, no terminal/process mirror, no richer command/mode/config updates, and no live editor proof yet. `smoke-tested`
