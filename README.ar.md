...
استخدم النموذج الذي تفضله. شغّله محليًا، على خادم، عبر Docker، أو من WSL2. استخدمه من الطرفية، أو Telegram، أو WhatsApp، أو Discord التجريبي.
...
| وكيلًا يرافقك أينما تعمل | CLI وTelegram وWhatsApp، مع دعم Discord بشكل تجريبي. |
...
لخطوات الإعداد الكاملة، راجع [Quickstart](https://estacoda.kemetresearch.com/docs/getting-started/quickstart).
...
لواجهة الأوامر الكاملة، راجع [CLI Commands](https://estacoda.kemetresearch.com/docs/reference/cli-commands).
...
تعمل المزوّدات المتوافقة مع OpenAI عند تحديد `baseUrl` صراحة. هناك مزوّدون إضافيون متاحون عبر الإعدادات، والمزيد قادم.

### القنوات

| القناة | مستوى النضج |
|---|---|
| CLI | واجهة التفاعل المباشرة المدعومة |
| Telegram | مثبت عمليًا |
| WhatsApp | مثبت عمليًا |
| Discord | تجريبي |
...
راجع [State and Files](https://estacoda.kemetresearch.com/docs/reference/state-and-files) للنموذج الكامل للحالة.
...
راجع [Security and Approvals](https://estacoda.kemetresearch.com/docs/user-guide/security-and-approvals) للنموذج الكامل.

---

## الوثائق

كل الوثائق موجودة على [estacoda.kemetresearch.com/docs](https://estacoda.kemetresearch.com/docs/).

| القسم | ماذا يغطي |
|---|---|
| [Quickstart](https://estacoda.kemetresearch.com/docs/getting-started/quickstart) | التثبيت، الإعداد، وأول جلسة |
| [Installation](https://estacoda.kemetresearch.com/docs/getting-started/installation) | مسارات التثبيت ودعم أنظمة التشغيل |
| [Updating](https://estacoda.kemetresearch.com/docs/getting-started/updating) | أوامر التحديث، التوجيه، وحدود الأمان |
| [Uninstall](https://estacoda.kemetresearch.com/docs/getting-started/uninstall) | سلوك الإزالة وحدود البيانات |
| [CLI Usage](https://estacoda.kemetresearch.com/docs/user-guide/cli) | الأوامر، الجلسات، والملفات الشخصية |
| [Providers](https://estacoda.kemetresearch.com/docs/user-guide/providers) | إعداد المزوّدين، مستوى النضج، والتوجيه |
| [Channels](https://estacoda.kemetresearch.com/docs/user-guide/channels) | Telegram وWhatsApp وDiscord |
| [Gateway](https://estacoda.kemetresearch.com/docs/user-guide/gateway) | وضع الخدمة، التشخيص، والموافقات |
| [Skills](https://estacoda.kemetresearch.com/docs/user-guide/skills) | التحميل، التطور، والمقترحات |
| [Memory](https://estacoda.kemetresearch.com/docs/user-guide/memory) | ذاكرة الملف الشخصي، الترقية، والحدود |
| [Security and Approvals](https://estacoda.kemetresearch.com/docs/user-guide/security-and-approvals) | الأوضاع، حدود الثقة، والحواجز الصلبة |
| [Configuration](https://estacoda.kemetresearch.com/docs/reference/configuration) | مرجع ملف الإعدادات |
| [CLI Commands](https://estacoda.kemetresearch.com/docs/reference/cli-commands) | مرجع كامل للأوامر والخيارات |
| [Troubleshooting](https://estacoda.kemetresearch.com/docs/reference/troubleshooting) | الأعطال الشائعة وطرق التعافي |
...
راجع [Updating](https://estacoda.kemetresearch.com/docs/getting-started/updating) لواجهة التحديث الكاملة.
...
راجع [Uninstall](https://estacoda.kemetresearch.com/docs/getting-started/uninstall) للسلوك الخاص بكل طريقة تثبيت وقواعد الملكية.
