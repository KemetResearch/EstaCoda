...
استخدم النموذج الذي تفضله. شغّله محليًا، على خادم، عبر Docker، أو من WSL2. استخدمه من الطرفية، أو Telegram، أو WhatsApp، مع قنوات إضافية قريبًا.
...
| وكيلًا يرافقك أينما تعمل | CLI وTelegram وWhatsApp اليوم، مع قنوات إضافية في الطريق. |
...
| [Channels](https://estacoda.kemetresearch.com/docs/user-guide/channels) | Telegram وWhatsApp وإعداد القنوات |
