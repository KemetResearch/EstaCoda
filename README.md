...
- **Voice**: hosted TTS (OpenAI, ElevenLabs, MiniMax, Gemini, xAI) and hosted STT (OpenAI, Groq, xAI) are supported. Local STT via command engine and faster-whisper is supported. Local TTS and Mistral voice remain deferred.
